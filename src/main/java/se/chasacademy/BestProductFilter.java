...
public class BestProductFilter implements IBestProductFilter{
    ...
    private static final Logger logger = LoggerFactory.getLogger(BestProductFilter.class);
    ...
    public void top3Products(Map<String, List<Order>> ordersByCustomer,
        ...
        try {
            ...
            logger.info("Displayed top 3 products successfully.");

        } catch (Exception e) {
            System.out.println("An unexpected error occurred while displaying top products.");
            logger.error("Error in BestProductFilter.top3Products", e);
        }
    }
}
